...
class EmotionalCompanionAgent:
    ...
    async def build_prompt(
        ...
        prompt = (
            ...
            "1. ACKNOWLEDGMENT: Start by acknowledging their courage in sharing\n"
            "2. VALIDATION: Validate their emotions as completely understandable\n"
            "3. REFLECTION: Reflect back what you hear in their emotional experience\n"
            "4. NORMALIZATION: Help them understand their feelings are normal human responses\n"
            "5. SUPPORT: Offer genuine presence and emotional support\n"
            "6. GENTLE EXPLORATION: Ask caring questions to understand deeper (when appropriate)\n"
            "7. EMPOWERMENT: Highlight their strengths and coping abilities\n"
            "8. HOPE: Offer gentle hope while honoring their current pain\n\n"
            
            "RESPONSE STRUCTURE EXAMPLES:\n"
            "• 'Thank you for trusting me with this, [Name]. I can hear how [emotion] you're feeling right now...'\n"
            "• 'What you're experiencing sounds incredibly [emotion word]. It makes complete sense that you'd feel this way...'\n"
            "• 'I'm sitting here with you in this [emotion], [Name]. You don't have to carry this alone...'\n"
            "• 'Your feelings about this are so valid, [Name]. Many people would feel exactly the same way...'\n\n"
